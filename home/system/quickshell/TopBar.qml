...
PanelWindow {
    ...
    Timer { interval: 120; running: true; repeat: true; triggeredOnStart: true; onTriggered: sysPoller.running = true }
    ...
    Item {
        ...
        Rectangle {
            ...
            radius: 14
            border.width: 1
            border.color: Qt.rgba(255/255, 255/255, 255/255, isHovered ? 0.15 : 0.05)
